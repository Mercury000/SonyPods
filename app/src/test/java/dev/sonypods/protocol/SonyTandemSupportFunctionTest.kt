...
class SonyTandemSupportFunctionTest {
    ...
    fun functionTypeEnum_roundTripsKnownCodes() {
        ...
        assertEquals(SonyV2FunctionType.CONCIERGE_DATA, SonyV2FunctionType.fromByteCode(SonyTable.NO_1, 0x10))
        assertEquals(SonyV2FunctionType.CONNECTION_STATUS, SonyV2FunctionType.fromByteCode(SonyTable.NO_1, 0x11))
        assertEquals(SonyV2FunctionType.CODEC_INDICATOR, SonyV2FunctionType.fromByteCode(SonyTable.NO_1, 0x12))
        assertEquals(SonyV2FunctionType.HEAD_GESTURE_ON_OFF_TRAINING, SonyV2FunctionType.fromByteCode(SonyTable.NO_1, 0xFF.toByte()))
        assertEquals(SonyV1FunctionType.BATTERY_LEVEL, SonyV1FunctionType.fromByteCode(0x11))
        assertEquals(SonyV1FunctionType.UPSCALING_INDICATOR, SonyV1FunctionType.fromByteCode(0x12))
        assertEquals(SonyV1FunctionType.LEFT_RIGHT_CONNECTION_STATUS, SonyV1FunctionType.fromByteCode(0x17))
        assertEquals(SonyV1FunctionType.CONCIERGE_DATA, SonyV1FunctionType.fromByteCode(0x22))
        assertEquals(SonyV1FunctionType.TANDEM_KEEP_ALIVE, SonyV1FunctionType.fromByteCode(0x23))
        assertEquals(SonyV1FunctionType.VIBRATOR_ALERT_NOTIFICATION, SonyV1FunctionType.fromByteCode(0x92.toByte()))
        assertEquals(SonyV1FunctionType.ACTION_LOG_NOTIFIER, SonyV1FunctionType.fromByteCode(0xC1.toByte()))
